  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="../../index3.html" class="brand-link">
        <img src="<?= base_url('assets/backend/theme') ?>/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="<?= base_url('assets/backend/theme') ?>/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
            <a class="d-block">
              <?= session()->get("user_login")['first_name'];?>
              <?= session()->get("user_login")['last_name'];?>
            </a>
          </div>
        </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?=base_url('user/categories')?>" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>List Category</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              <a href="<?= base_url("user/settings") ?>" class="nav-link">
                <i class="fas fa-circle nav-icon"></i>
